...
- `스터디 > 바이브코딩` 아래 DB 3개 생성 — 주소는 [notion_targets.json](notion_targets.json)
  - 📖 강의 노트 / 🛠️ 도구 사전 / 🔗 링크 모음
...
| 새 위치 | 옮길 것 | 원본 ID |
|---|---|---|
| 🛠️ 도구 사전 | Claude Code (플러그인·statusline·`shift+tab`) | `3ac2d2f5-...-8031`, `3ac2d2f5-...-8099`, `3ac2d2f5-...-804e` |
| 🛠️ 도구 사전 | GitHub (명령어 표까지 정리됨, 가장 완성도 높음) | `2ab2d2f5-...-8160` |
| 🛠️ 도구 사전 | context7 MCP (`npx ctx7 setup`) | `2ab2d2f5-...-815f` |
| 🛠️ 도구 사전 | Render / aiven / neon / GCP | `2ab2d2f5-...-81ae`, `2ab2d2f5-...-81b7` |
| 🛠️ 도구 사전 | Codex + Firebase | `a76c5965-...` |
| 📖 강의 노트 | 카카오맵 API 키 발급 절차 | `3ac2d2f5-...-806f` |
| 📖 강의 노트 | Render 배포 2단계 (제목 없음) | `2ab2d2f5-...-81b7` |
| 🔗 링크 모음 | 짐코딩 노션 3개, dribbble, 배포서비스 4개, 공공API 5개 | 여러 곳 |
...
- **DB 제목 관련 질문이 미해결**: "제목이 드라이버점검 db는 좀 아니지 않니?" 라고 하셨는데
  어느 DB를 말씀하신 건지 확인 못 함. 현재 제목은 `강의 노트` / `도구 사전` / `링크 모음`.
  이어서 "바이브코딩 하위로 들어가는 게 좋겠다"고 하셨는데, 3개 모두 이미 바이브코딩 하위임.
  → **다음에 무엇을 가리킨 것인지 먼저 물어볼 것.**
